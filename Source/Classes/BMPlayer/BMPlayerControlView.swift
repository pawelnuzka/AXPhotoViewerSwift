...
open class BMPlayerControlView: UIView {
    ...
    open func autoFadeOutControlViewWithAnimation() {
        ...
        if BMPlayerConf.enableAutoHideControls == false { return }
    ...
    open func controlViewAnimation(isShow: Bool) {
        ...
        UIView.animate(withDuration: 0.3, animations: {
            ...
            //Changed dimm 0.4 to 0.0 isShow ? 0.4 : 0.0
    ...
    func setupUIComponents() {
        ...
        mainMaskView.backgroundColor = UIColor ( red: 0.0, green: 0.0, blue: 0.0, alpha: 0 )
        ...
        if BMPlayerConf.enableTouchGesture {
    ...
    func addSnapKitConstraint() {
        ...
        bottomMaskView.snp.makeConstraints { (make) in
            make.left.right.equalTo(mainMaskView)
            make.height.equalTo(50)
            make.bottom.equalTo(mainMaskView).offset(-30)
        }
        ...
        playButton.snp.makeConstraints { (make) in
            make.width.equalTo(50)
            make.height.equalTo(50)
            make.left.equalTo(bottomMaskView.snp.left).offset(20)
